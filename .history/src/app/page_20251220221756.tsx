          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="relative min-h-[400px] bg-black/40 rounded-3xl border border-white/10 p-8 md:p-12 backdrop-blur-sm overflow-hidden">
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  {(activeDay === 1 ? [
                    { time: "01:00 PM", endTime: "01:20 PM", event: "Inauguration", desc: "Opening ceremony and instructions." },
                    { time: "01:20 PM", endTime: "04:00 PM", event: "Development Phase 1", desc: "Hacktide officially begins." },
                    { time: "04:00 PM", endTime: "04:45 PM", event: "Snacks Break", desc: "Quick refuel for the teams." },
                    { time: "04:45 PM", endTime: "06:00 PM", event: "Review Round 1", desc: "Initial progress evaluation." },
                    { time: "06:00 PM", endTime: "10:00 PM", event: "Development Phase 2", desc: "Deep diving into core features." },
                    { time: "10:00 PM", endTime: "11:00 PM", event: "Dinner Break", desc: "Main fueling session." },
                    { time: "11:00 PM", endTime: "01:30 AM", event: "Development Phase 3", desc: "Pushing through the night." },
                  ] : [
                    { time: "01:30 AM", endTime: "02:30 AM", event: "Review Round 2", desc: "Late night progress check." },
                    { time: "02:30 AM", endTime: "06:00 AM", event: "Overnight Development", desc: "Maximum focus period." },
                    { time: "06:00 AM", endTime: "07:00 AM", event: "Review 3 + Shortlisting", desc: "Selecting the top 40 teams." },
                    { time: "07:00 AM", endTime: "09:00 AM", event: "Final Refinement", desc: "Top 40 teams polish prototypes." },
                    { time: "09:00 AM", endTime: "10:00 AM", event: "Breakfast Break", desc: "Morning refresh." },
                    { time: "10:00 AM", endTime: "01:00 PM", event: "Final Presentations", desc: "Winners Announcement & Gratitude." },
                  ]).map((item, i) => (
                    <motion.div 
                      key={i}
                    ...
                    >
                      ...
                      <div className="relative flex-1 pb-8 border-l border-white/10 pl-8 last:pb-0 last:border-l-0">
                        <div className="absolute -left-[5px] top-2 w-2.5 h-2.5 rounded-full bg-[#10d900] shadow-[0_0_10px_#10d900] group-hover:scale-125 transition-transform duration-300" />
