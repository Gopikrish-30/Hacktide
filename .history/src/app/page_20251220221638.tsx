...
export default function HackathonLanding() {
  ...
  React.useEffect(() => {
    ...
    // Countdown logic - Dec 26, 2025, 12:00 AM
      ...
      <SpaceBackground>
          ...
          <nav className="hidden lg:flex items-center gap-2 px-4 py-2 rounded-full border border-white/10 bg-black/50 backdrop-blur-md">
            ...
            <div className="ml-2">
              <Magnetic strength={0.15}>
                <Button size="sm" className="rounded-full bg-white text-black hover:bg-white/90 shadow-[0_0_15px_rgba(255,255,255,0.1)] hover:shadow-[0_0_20px_rgba(255,255,255,0.2)]" data-magnetic-target="true" asChild>
        ...
        <main className="relative z-10">
          ...
          >
            <div className="relative">
              <GlowingText 
                text="HACKTIDE" 
                className="text-6xl sm:text-8xl md:text-[10rem]" 
                delay={2}
              />
            </div>
            ...
            <div className="flex flex-col items-center gap-8 mb-10">
              ...
              <Magnetic strength={0.2} range={80}>
                <Button size="lg" className="h-16 px-10 text-xl rounded-full bg-[#10d900] text-black hover:bg-[#10d900]/90 group shadow-[0_0_20px_rgba(16,217,0,0.3)] hover:shadow-[0_0_35px_rgba(16,217,0,0.5)] transition-shadow duration-300" data-magnetic-target="true" asChild>
                  <a href="https://anokha.amrita.edu/events/c0344cd9-5522-4817-a409-4d671c23f0a3" target="_blank" rel="noopener noreferrer">
                    Register Now
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <motion.div
                ...
                className="relative"
              >
                <div className="aspect-square bg-gradient-to-tr from-[#10d900]/20 to-emerald-800/20 rounded-2xl border border-white/5 flex items-center justify-center p-8 overflow-hidden group">
                  <Telescope className="w-32 h-32 text-white/30 transition-colors duration-500" />
                  <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(16,217,0,0.1),transparent)] opacity-0 transition-opacity" />
                </div>
              </motion.div>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                { 
                  ...
                  icon: Orbit, 
                  desc: "24-hour continuous hackathon to transform ideas into functional prototypes. Initial evaluation shortlists the top 40 teams based on progress." 
                },
                { 
                  phase: "Phase 3", 
                  title: "Final Orbit", 
                  icon: Trophy, 
                  desc: "Shortlisted 40 teams present refined prototypes to the judging panel. Top 2 winners selected based on excellence and impact." 
                },
              ].map((item, i) => (
                <motion.div
                  key={i}
        ...
        <section id="timeline" className="py-24 px-4 border-y border-white/5">
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-4">
              <div>
                <h2 className="text-4xl font-bold italic text-[#10d900]">Mission Timeline</h2>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <div className="space-y-6">
                <h3 className="text-xl font-bold mb-8 text-[#10d900] italic flex items-center gap-2">
                  <Calendar className="w-5 h-5" /> 07.01.2026 - Day 1
                </h3>
                {[
                  { time: "01:00 PM – 01:20 PM", event: "Inauguration", desc: "Opening ceremony and instructions." },
                  { time: "01:20 PM – 04:00 PM", event: "Development Phase 1", desc: "Hacktide officially begins." },
                  { time: "04:00 PM – 04:45 PM", event: "Snacks Break", desc: "Quick refuel for the teams." },
                  { time: "04:45 PM – 06:00 PM", event: "Review Round 1", desc: "Initial progress evaluation." },
                  { time: "06:00 PM – 10:00 PM", event: "Development Phase 2", desc: "Deep diving into core features." },
                  { time: "10:00 PM – 11:00 PM", event: "Dinner Break", desc: "Main fueling session." },
                  { time: "11:00 PM – 01:30 AM", event: "Development Phase 3", desc: "Pushing through the night." },
                ].map((item, i) => (
                    <div key={i} className="flex gap-4 md:gap-6 group">
                      <div className="w-20 sm:w-32 shrink-0 text-xs sm:text-sm font-mono text-white/60 pt-1 transition-colors">
                        {item.time.split(' – ')[0]}
                      </div>
                      <div className="pb-6 border-l border-white/10 pl-4 md:pl-6 relative">
                        <div className="absolute w-2 h-2 rounded-full bg-white/20 -left-[5px] top-2 transition-colors" />
                        <div className="font-bold text-white mb-1 text-sm sm:text-base">{item.event}</div>
              ...
              <div className="space-y-6">
                <h3 className="text-xl font-bold mb-8 text-[#10d900] italic flex items-center gap-2">
                  <Calendar className="w-5 h-5" /> 08.01.2026 - Day 2
                </h3>
                {[
                  { time: "01:30 AM – 02:30 AM", event: "Review Round 2", desc: "Late night progress check." },
                  { time: "02:30 AM – 06:00 AM", event: "Overnight Development", desc: "Maximum focus period." },
                  { time: "06:00 AM – 07:00 AM", event: "Review 3 + Shortlisting", desc: "Selecting the top 40 teams." },
                  { time: "07:00 AM – 09:00 AM", event: "Final Refinement", desc: "Top 40 teams polish prototypes." },
                  { time: "09:00 AM – 10:00 AM", event: "Breakfast Break", desc: "Morning refresh." },
                  { time: "10:00 AM – 01:00 PM", event: "Final Presentations", desc: "Winners Announcement & Gratitude." },
                ].map((item, i) => (
                    <div key={i} className="flex gap-4 md:gap-6 group">
                      <div className="w-20 sm:w-32 shrink-0 text-xs sm:text-sm font-mono text-white/60 pt-1 transition-colors">
                        {item.time.split(' – ')[0]}
        ...
        <section id="sponsors" className="py-24 px-4 border-t border-white/5 relative overflow-hidden">
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            <div className="max-w-4xl mx-auto p-8 md:p-12 rounded-3xl border border-white/10 bg-white/[0.06] backdrop-blur-md relative group overflow-hidden shadow-2xl">
              <div className="absolute inset-0 bg-gradient-to-br from-[#10d900]/10 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              ...
              <div className="flex flex-wrap justify-center items-center gap-12 md:gap-24 relative z-10">
                ...
                >
                  <div className="absolute -inset-4 bg-white/5 rounded-2xl blur-xl opacity-0 group-hover/logo:opacity-100 transition-opacity" />
                  <img 
                    ...
                    className="h-12 md:h-16 w-auto object-contain relative z-10 brightness-90 hover:brightness-100 transition-all duration-300"
                  />
                </motion.div>
                ...
                >
                  ...
                  <img 
                    ...
                    alt="Avantech" 
                    className="h-12 md:h-16 w-auto object-contain relative z-10 brightness-90 hover:brightness-100 transition-all duration-300 rounded-lg"
                  />
                </motion.div>
              </div>
            </div>
