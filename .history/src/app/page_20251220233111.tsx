          ...
          <nav className="hidden lg:flex items-center gap-2 px-4 py-2 rounded-full border border-white/10 bg-black/50 backdrop-blur-md">
            ...
            <div className="ml-2">
              ...
              >
                ...
                <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-[#10d900] px-4 py-1 text-sm font-bold text-black backdrop-blur-3xl hover:bg-[#10d900]/80 transition-colors">
                  Register Now
                </span>
              </a>
            </div>
        ...
        <main className="relative z-10">
          ...
          >
            ...
            <div className="flex flex-col items-center gap-8 mb-10">
              ...
              >
                <span className="absolute inset-[-1000%] animate-[spin_2s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#000000_0%,#10d900_50%,#000000_100%)]" />
                <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-black px-10 text-xl font-medium text-white backdrop-blur-3xl hover:bg-white/10 transition-colors">
                  Register Now
