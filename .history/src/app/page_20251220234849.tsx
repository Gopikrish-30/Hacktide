          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <motion.div
                ...
                className="relative"
              >
                <div className="aspect-square bg-gradient-to-tr from-[#10d900]/20 to-emerald-800/20 rounded-2xl border border-white/5 flex items-center justify-center overflow-hidden group relative">
                  <img 
                    src="/poster.jpeg" 
